...
- [1. Data Warehouse Optimization](#1-data-warehouse-optimization)
- [2. Spark](#2-spark)
- [3. Data Protection Rules (if we can get it to work in toronto)](#3-data-protection-rules-if-we-can-get-it-to-work-in-toronto)
- [4. RAG Agent](#4-rag-agent)
- [5.  Natural Language to SQL Agent](#5--natural-language-to-sql-agent)
...
## 3. Data Protection Rules (if we can get it to work in toronto)
...
## 5.  Natural Language to SQL Agent
